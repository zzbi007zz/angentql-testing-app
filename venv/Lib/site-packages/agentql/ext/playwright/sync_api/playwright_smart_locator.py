...
class Page(_Page):
    if TYPE_CHECKING:
        ...
        def get_by_prompt(
            ...
            mode (ResponseMode) (optional): The response mode. Can be either `standard` or `fast`.
...
def _goto(
    ...
    *,
    ...
    if self._page_monitor is None:
        ...
        add_request_event_listeners_for_page_monitor_shared(self, self._page_monitor)
